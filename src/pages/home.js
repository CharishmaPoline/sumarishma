...
const sections = [
  ...
  { name: "Music", route: "/music", icon: null },
  { name: "Cooking", route: "/cooking", icon: null },
  { name: "Fashion", route: "/fashion", icon: null },
  { name: "Entertainment", route: "/entertainment", icon: null },
];
...
const Home = () => {
  ...
  // Search handler - user types category and presses search
  ...
  // Logout handler - remove login info and redirect to login page
  const handleLogout = () => {
    localStorage.removeItem("isLoggedIn"); // Or remove your auth token
    navigate("/login");
  };
  ...
  return (
    ...
    >
      ...
      <header style={{ marginBottom: "20px" }}>
        ...
        />
        <h1 style={{ fontSize: "34px", fontWeight: "bold", color: "indigo" }}>
      ...
      <section>
        <h2
          style={{ color: "indigo", marginBottom: "20px", fontSize: "24px" }}
        >
          Explore Categories
        </h2>
        <div
